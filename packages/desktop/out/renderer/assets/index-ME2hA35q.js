...
function FolderPicker({ onSelect }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", className: "text-white/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-[15px] font-semibold text-white/90", children: "Open a project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-white/40", children: "Choose a folder to start coding with AI" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" }) }),
          "Browse folder"
        ]
      }
    )
...
function ChatPanel({ cwd }) {
  const [messages, setMessages] = reactExports.useState([]);
  const [input, setInput] = reactExports.useState("");
  const [isRunning, setIsRunning] = reactExports.useState(false);
  const [permissionMode, setPermissionMode] = reactExports.useState("edit");
  const historyRef = reactExports.useRef([]);
  const activeJobRef = reactExports.useRef(null);
  ...
  const handleAgentEvent = reactExports.useCallback(
    (jobId, event) => {
      ...
      setMessages((prev) => {
        ...
        if (event.type === "tool-result") {
          const updated = (last.toolCalls ?? []).map(
            (tc) => tc.id === event.id ? { ...tc, output: event.output } : tc
          );
          return [
            ...prev.slice(0, -1),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 space-y-4", children: [
      messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-white/30", children: "Ask anything about your codebase" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-white/20 font-mono", children: cwd })
      ] }) }),
      messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsx(MessageBubble, { message: msg }, msg.id)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: bottomRef })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 border-t border-white/[0.06] p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setPermissionMode((m) => m === "edit" ? "plan" : "edit"),
          className: `shrink-0 rounded px-2 py-1 text-[11px] font-medium transition-colors ${permissionMode === "plan" ? "bg-amber-500/20 text-amber-400" : "bg-white/[0.06] text-white/40 hover:text-white/60"}`,
          title: "Toggle plan mode",
          children: permissionMode === "plan" ? "Plan" : "Edit"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
...
function MessageBubble({ message }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${isUser ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `max-w-[85%] rounded-xl px-3.5 py-2.5 ${isUser ? "bg-white/90 text-black" : message.isError ? "bg-red-500/10 text-red-400" : "bg-white/[0.06] text-white/85"}`,
      children: [
        message.content && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "selectable whitespace-pre-wrap text-[13px] leading-relaxed", children: [
          message.content,
          message.isStreaming && !message.content && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-3.5 w-0.5 animate-pulse bg-current opacity-70 ml-0.5" })
        ] }),
        message.isStreaming && !message.content && (message.toolCalls ?? []).length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-3.5 w-0.5 animate-pulse bg-current opacity-70" }),
        (message.toolCalls ?? []).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 space-y-1.5", children: (message.toolCalls ?? []).map((tc) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCallItem, { toolCall: tc }, tc.id)) })
      ]
    }
  ) });
}
function ToolCallItem({
  ...
  const isDone = toolCall.output !== void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-white/[0.08] bg-black/30 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `h-1.5 w-1.5 rounded-full shrink-0 ${isDone ? "bg-green-400" : "bg-amber-400 animate-pulse"}`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[11px] text-white/60", children: toolCall.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-[10px] text-white/25", children: expanded ? "▲" : "▼" })
        ]
      }
    ),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/[0.06] px-3 py-2 space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-medium text-white/30 uppercase mb-1", children: "Input" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "selectable whitespace-pre-wrap break-all font-mono text-[11px] text-white/50 leading-relaxed", children: JSON.stringify(toolCall.input, null, 2) })
      ] }),
      toolCall.output !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-medium text-white/30 uppercase mb-1", children: "Output" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "selectable whitespace-pre-wrap break-all font-mono text-[11px] text-white/50 leading-relaxed max-h-48 overflow-y-auto", children: toolCall.output })
      ] })
    ] })
  ] });
}
...
function SettingsModal({ onClose }) {
  ...
  reactExports.useEffect(() => {
    window.api.getSettings().then(
      (s) => setSettings({ modelId: s.modelId, providerApiKeys: s.providerApiKeys })
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md rounded-2xl border border-white/[0.08] bg-[#111] shadow-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-white/[0.06] px-5 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[14px] font-semibold text-white/90", children: "Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onClose,
              className: "text-white/30 hover:text-white/60 transition-colors",
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-medium text-white/40 uppercase", children: "Model" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "select",
              {
                ...
                children: models.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: m.id, className: "bg-[#111]", children: m.label }, m.id))
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-medium text-white/40 uppercase", children: "API Keys" }),
            KEY_FIELDS.map(({ key, label, placeholder }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[12px] text-white/50", children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "password",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 border-t border-white/[0.06] px-5 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onClose,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: saved ? "Saved!" : saving ? "Saving..." : "Save"
            }
          )
        ] })
      ] })
...
function App() {
  ...
  reactExports.useEffect(() => {
    window.api.getSettings().then((s) => {
      const keys = s.providerApiKeys;
      const anyKey = Object.values(keys).some((v) => v?.trim());
      setHasApiKey(anyKey);
      if (!anyKey) setSettingsOpen(true);
    });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen flex-col bg-[#0a0a0a] text-white overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold text-white/70 titlebar-no-drag select-none", children: cwd ? cwd.split("/").pop() : "Staged" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-no-drag flex items-center gap-2", children: [
            cwd && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setCwd(null),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: !cwd ? /* @__PURE__ */ jsxRuntimeExports.jsx(FolderPicker, { onSelect: setCwd }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPanel, { cwd }) }),
